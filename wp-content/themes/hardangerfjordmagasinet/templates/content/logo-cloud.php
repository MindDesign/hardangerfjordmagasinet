<div class="bg-white">
    <div class="max-w-5xl mx-auto py-12 px-4 sm:px-6 lg:px-8" id="logo-wrapper">
        <div class="grid grid-cols-2 gap-8 md:grid-cols-6 lg:grid-cols-5" id="thumbnail-carousel">
            ...
            <div class="col-span-1 flex justify-center md:col-span-2 lg:col-span-1">
                <img class="w-auto h-12" src="<?php echo get_stylesheet_directory_uri() . '/img/logo-ulvik-smal.png'; ?>" alt="">
            </div>
            <div class="col-span-1 flex justify-center md:col-span-3 lg:col-span-1">
                <img class="w-auto h-12" src="<?php echo get_stylesheet_directory_uri() . '/img/voss-herad-logo.png'; ?>" alt="">
            </div>
