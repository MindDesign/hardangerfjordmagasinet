...
<?php if ( $has_token ) : ?>
	...
	$gam_ads = Advanced_Ads_Gam_Admin::get_instance()->get_all_gam_ads();
	if ( empty( $gam_ads ) ) {
		?>
		<p><a class="button button-primary" id="gamapi-new-ad" href="<?php echo esc_url( admin_url( 'post-new.php?post_type=advanced_ads&new_ad_type=gam' ) ); ?>"><?php esc_html_e( 'Place your first ad', 'advanced-ads-gam' ); ?></a></p>
																				<?php
	}
...
<div id="gam-settings-overlay">
	<div>
		<style type="text/css">
			...
			#gamapi-not-enabled, #gamapi-too-much-ads {
				display: none;
			}
		</style>
	</div>
